...
public class ConsultationSpecialist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onUserClickListener = new UsersAdapter.OnUserClickListener() {
            ...
            public void OnUserClicked(int position) {
                startActivity(new Intent(ConsultationSpecialist.this, MessageActivity.class).
    ...
    private void getUsers(){
        ...
        FirebaseDatabase.getInstance().getReference("users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                usersAdapter = new UsersAdapter(users, ConsultationSpecialist.this, onUserClickListener);
                recyclerView.setLayoutManager(new LinearLayoutManager(ConsultationSpecialist.this));
