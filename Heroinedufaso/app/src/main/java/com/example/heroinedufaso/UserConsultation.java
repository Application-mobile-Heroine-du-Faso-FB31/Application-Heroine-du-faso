...
public class UserConsultation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onUserClickListener = new UsersAdapter.OnUserClickListener() {
            ...
            public void OnUserClicked(int position) {
                startActivity(new Intent(UserConsultation.this, MessageActivity.class).
    ...
    private void getUsers(){
        ...
        FirebaseDatabase.getInstance().getReference("healthSpecialist").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                usersAdapter = new UsersAdapter(users, UserConsultation.this, onUserClickListener);
                recyclerView.setLayoutManager(new LinearLayoutManager(UserConsultation.this));
