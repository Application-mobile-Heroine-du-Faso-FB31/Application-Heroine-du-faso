...
public class ProfileSpecialistActivity extends AppCompatActivity {
    ...
    private EditText fullName, speciality, city;
    private TextView phoneNumber, birthday, email;
    ...
    private HealthSpecialist currentUser = new HealthSpecialist();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email = findViewById(R.id.email_txtV_profile);
        speciality = findViewById(R.id.specialisation_profile);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ProfileSpecialistActivity.this, HomePageHealthSpecialist.class));
                finish();
            }
        });
        ...
        updateProfileInfoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!TextUtils.isEmpty(fullName.getText().toString().trim())
                    ...
                    currentUser.setSpecialisation(speciality.getText().toString());
                    currentUser.setCity(city.getText().toString());

                    databaseReference.setValue(currentUser);

                    Toast.makeText(ProfileSpecialistActivity.this, "Vos données personnelles ont bien été modifiées.", Toast.LENGTH_SHORT).show();

                }else{
                    Toast.makeText(ProfileSpecialistActivity.this, "Veuillez remplir toutes les sections, s'il vous plaît.", Toast.LENGTH_SHORT).show();
                }
    ...
    public void getData(){
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("healthSpecialist").
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                HealthSpecialist user = dataSnapshot.getValue(HealthSpecialist.class);
                ...
                currentUser.setSpecialisation(user.getSpecialisation());
                ...
                speciality.setText(currentUser.getSpecialisation());
                ...
                .putFile(selectedImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(ProfileSpecialistActivity.this, "Image a été téléversé.", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(ProfileSpecialistActivity.this, "Image n'a pas pu être téléversé.", Toast.LENGTH_SHORT).show();
                        }
                        progressDialog.dismiss();
                    }
                });
